...
'Создать': 'Создать',
'Создать первого пользователя': 'Создать первого пользователя',
'Сохранить': 'Сохранить',
'Статусы': 'Статусы',
'Статусы заявок': 'Статусы заявок',
'Статусы комплектаций': 'Статусы комплектаций',
'Статусы комплектов': 'Статусы комплектов',
'Статусы проектов': 'Статусы проектов',
'Типы позиций номенклатуры': 'Типы позиций номенклатуры',
}
